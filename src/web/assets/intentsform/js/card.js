	  ...
	  Card.prototype.validToggler = function(validatorName) {
	    ...
	    if (validatorName === "cardExpiry") { 
	      isValid = function(val) {
	        ...
	        return true; //Payment.fns.validateCardExpiry(objVal.month, objVal.year);
	      };
	  ...
	  Payment = (function() {
	    ...
	    Payment.fns = {
	      cardExpiryVal: function(value) {
			...
			ref = value.split('/'), month = ref[0], year = ref[1];			
	        // if ((year != null ? year.length : void 0) === 4 && /^\d+$/.test(year)) {
	      ...
	      validateCardExpiry: function(month, year) {
	        ...
	        if (year.length === 4) {
	          prefix = (new Date).getFullYear();
	          prefix = prefix.toString().slice(0, 4);
	          year = prefix + year;
	        }
